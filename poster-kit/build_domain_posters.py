...
DOMAINS = [
    ...
    ("Business Analyst",       "business", "Business Analyst Intern"),
    ("MERN Stack",             "mern",     "MERN Stack Intern"),
    ("HR Management",          "hr",       "HR Management Intern"),
    ("Data Science",           "datasci",  "Data Science Intern"),
    ("Java Development",       "java",     "Java Development Intern"),
    ("Space Research",         "space",    "Space Research Intern"),
    ("Cyber Security",         "cyber",    "Cyber Security Intern"),
    ("Venture Capital",        "venture",  "Venture Capital Intern"),
    ("Flutter",                "flutter",  "Flutter Intern"),

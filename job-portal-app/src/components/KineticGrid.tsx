...
/*
 * Kinetic grid background — a lattice that warps toward the pointer and
 * ripples on click. Ported from the supplied shadcn component; this app has
 * no `@/lib/utils`, so the one dependency (cn) is inlined and everything else
 * is the original canvas maths.
 */
...
export default function KineticGrid({
  ...
  return (
    <div className={cx('relative w-full min-h-screen overflow-hidden', globalColor === 'monochrome' ? 'bg-[#000000]' : 'bg-[#161618]', className)}>
